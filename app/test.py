...
def visitors_rank_task(location:str="nantong",date:str=None):
...
def task_main():
    # visitors_rank_task("kunshan","20251031")
    visitors_rank_task("nantong","20251209")
    # visitors_rank_task("jiangyin","20251031")
